...
" highlight for invisible chars
highlight NonText guifg=#cccccc guibg=#ffffff
highlight SpecialKey guifg=#cccccc guibg=#ffffff
highlight SpecialKey guibg=#cccccc guibg=#ffffff
